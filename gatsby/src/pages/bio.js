    ...
    <BioStyles>
      ...
      <div className="bio-content">
        ...
        <div className="bio-text">
          <p>My name is Daniel Gaylord, Maryland-born and Jersey-raised, but proudly calling NYC my current home. Always being interested in how things work no doubt led me to what I do today, both at my 'day job' and in my free time.</p>
          <p>Currently I act as a Computer Science Education Mangager for the <a href="https://cs4all.nyc" target="_blank" rel="noreferrer">New York City Department of Education's Computer Science for All (CS4All) team</a>. I use my background as both a computer science major and a computer science high school teacher to bring the joy and wonder of algorithms, programming, and abstract thinking to NYC teachers so they can prepare their students to be the next wave of future developers.</p>
